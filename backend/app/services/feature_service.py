...
from app.analysis.route_parser import RouteParser, RouteInfo
...
from app.analysis.api_extractor import APIExtractor, APIEndpoint
from app.analysis.feature_detector import SystemFeatureDetector, SystemFeature
from app.analysis.model_extractor import ModelExtractor, DataModel
from app.analysis.feature_tree import FeatureTreeBuilder, FeatureTree, FeatureNode
...
class FeatureService:
    ...
    def _should_skip(self, file_path: Path) -> bool:
        skip_dirs = {
            ...
            "coverage", ".pytest_cache", "migrations", "docs"
        }
